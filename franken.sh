...
KERNEL="Image"
DTBIMAGE="dtb"
export CLANG_PATH=~/android/clang/clang-r383902c/bin/
...
export LD_LIBRARY_PATH=${HOME}/android/clang/clang-r383902c/lib64:$LD_LIBRARY_PATH
...
ZIMAGE_DIR="${HOME}/android/8pro/out/arch/arm64/boot/"

# Functions
function clean_all {
		rm -rf ~/android/8pro/out/*
		cd $KERNEL_DIR
		echo
...
function make_boot {
		cp -vr ~/android/8pro/out/arch/arm64/boot/Image.gz-dtb ~/android/AnyKernel3.1/Image.gz-dtb
}
